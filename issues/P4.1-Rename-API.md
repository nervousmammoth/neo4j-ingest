...
**As a** developer
**I want** to implement file rename functionality using S3 copy-then-delete
**So that** users can organize their uploaded files without data loss

**As a** developer
**I want** to implement a delete endpoint
**So that** users can remove unwanted files from S3

**As a** developer
**I want** to ensure copy completes before delete
**So that** files are never lost due to failed operations
