...
**As a** user
**I want** to click on a CSV file to preview its contents
**So that** I can verify the data structure and content without downloading the entire file

**As a** user
**I want** to see the first 50 rows in a formatted table
**So that** I can understand column headers and sample data quickly

**As a** developer
**I want** to fetch only the first 100KB of the file
**So that** preview performance remains fast even for multi-gigabyte CSV files
