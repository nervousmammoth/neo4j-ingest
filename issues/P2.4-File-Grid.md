...
**As a** user
**I want** to see file details (name, size, date modified, type) in a sortable table
**So that** I can understand my data and find specific files quickly

**As a** user
**I want** to sort files by any column
**So that** I can organize my view based on what matters most to me (newest first, largest files, etc.)
