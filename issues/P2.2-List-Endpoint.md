...
**As a** user
**I want** to view the contents of my S3 bucket organized by folders
**So that** I can navigate through my uploaded files and understand their structure

**As a** developer
**I want** to efficiently query S3 using prefixes and delimiters
**So that** the application can handle buckets with 10,000+ files without performance issues
